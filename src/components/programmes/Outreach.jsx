  ...
  return (
    ...
    <div className="programmes-content">
            ...
            <h2 className="programmes-title-h2">
                  <span className="line1">The Community Outreach Programme.</span>
                  <span className="line2">Building Social Resilience in Douglas.</span>
            </h2>
            <p className="programmes-subtitle">Our Community Outreach Programme moves beyond physical aid to cultivate long term emotional 
            well being and social cohesion under trusted local guidance. By creating safe community spaces, mentorship initiatives, and 
            essential social support networks, we address the root causes of systemic hardship. This programme is designed to foster a resilient 
            neighborhood, break cycles of vulnerability, and provide individuals with the emotional guidance and community network needed to 
            thrive</p>
